...
const AboutUs = () => {
    return (
        <section className="bg-gradient-to-b from-teal-700 via-teal-800 to-violet-900 text-white py-16 px-6 md:px-16">
            <div className="max-w-5xl mx-auto text-center">
                ...
                At <span className="font-semibold">YoJobs</span>, we believe that the right job can change a life, 
