    ...
    return (
        <section className="bg-gradient-to-b from-teal-700 to-[#0A2A26] text-white py-16 px-6 md:px-16">
            <div className="max-w-5xl mx-auto">
                ...
                <p>
                    Welcome to <span className="font-semibold">Job Mzala</span>. By accessing or using our platform, 
                ...
                <div>
                    ...
                    <p>
                    You agree to use Job Mzala only for lawful purposes. You must not misuse the platform, 
                ...
                <div>
                    ...
                    for the information provided in their applications. Job Mzala is not responsible for the 
                ...
                <div>
                    ...
                    is the property of Job Mzala or its licensors and may not be used without permission.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                    Job Mzala is not liable for any damages resulting from your use of the platform, 
